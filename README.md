...
펌웨어 버전과 앱 버전은 따로 올라갑니다. **K 릴리즈에는 ver018 APK를 같이 올렸습니다.** F·G에 남아 있는 ver011보다 뒤의 버전이고, 아래 한국어 표시와 앱 업데이트 기능도 포함됩니다요.
...
- **건강 설정을 열 때 앱이 종료되던 문제를 고쳤습니다.** 건강 설정값이 아직 준비되지 않았을 때도 안전하게 기다렸다가 화면을 엽니다.
...
**[K · ver011 · Kkwabaegi](https://github.com/devuterian/PebbleOAO/releases/tag/v4.37.0-ver011-kkwabaegi) · 일반 릴리즈**

- 충전 한도를 80%, 90%, 100% 중에서 고를 수 있게 했습니다. 이번 한 번만 100%까지 충전하는 기능도 넣었습니다.
- 선택한 충전 한도에 맞춰 충전 완료 표시와 남은 시간 계산이 바뀝니다. 충전 전력과 남은 시간이 사라지던 문제도 고쳤습니다.
- 앱은 ver018로 올렸습니다. 건강 데이터가 아직 준비되지 않았을 때 건강 설정을 누르면 앱이 종료되던 문제를 고쳤습니다.
