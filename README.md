...
- **건강 앱의 한글 표시를 고쳤습니다.** 수면 시간이 `7시간 32분`처럼 제대로 나옵니다. `11시간 30분`, `12시간 59분`도 들어갑니다. “평소 수”는 “수요일 평균”으로 바꿨습니다. 수가 뭔가 했더니 수요일이었네요.
- **운동 기록의 시간이 잘리던 문제를 고쳤습니다.** 한글로 된 시간도 끝까지 들어가도록 고쳤고, 문구를 담는 공간이 부족할 때 잘못 처리하던 부분도 수정했습니다.

### 고치고 나면 이렇게 나옵니다

<p align="center">
  <img src="docs/_static/images/health/health-steps.png" width="200" alt="수정된 건강 앱 걸음 화면: 145걸음, 수요일 평균">
  <img src="docs/_static/images/health/health-sleep.png" width="200" alt="수정된 건강 앱 수면 화면: 7시간 32분, 수요일 평균">
</p>

에뮬레이터에서 찍은 화면입니다. 걸음 수랑 수면 시간은 확인하려고 넣은 예시 데이터입니다잉.

## 조잡해보이는데

네. 제가 쓰려고 만들었기 때문에 조잡합니다. 그래서 (혹시나 버그가 생긴다면) 알람이 안 울린다든지 뭐 어쩐다든지 할 수 있습니다.
