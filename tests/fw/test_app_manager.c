...
static PebbleProcessMdSystem s_launch_app = {
  ...
  .common = {
    ...
    .uuid = {
      0x7b, 0xbf, 0xf9, 0xbc, 0xb7, 0x62, 0x42, 0x19, 0x90, 0x03, 0x40, 0x86, 0x67, 0x5d, 0x62, 0x5d
    },
  },
};
...
static PebbleProcessMdSystem s_root_app = {
  ...
  .common = {
    ...
    .uuid = {
      0x3f, 0xca, 0x66, 0xe2, 0x8c, 0x66, 0x46, 0xc6, 0x80, 0x11, 0x33, 0x0f, 0xcc, 0xc9, 0xba, 0xa9
    },
  },
};
...
static PebbleProcessMdSystem s_third_party_app = {
  ...
  .common = {
    ...
    .uuid = {
      0x04, 0xc5, 0x24, 0x01, 0x4d, 0xbe, 0x40, 0x8b, 0xb7, 0x3a, 0x0e, 0x80, 0xef, 0x09, 0xaf, 0x74
    },
  },
};
...
static PebbleProcessMdFlash s_borked_app = {
  ...
  .sdk_version = {
    .major = PROCESS_INFO_CURRENT_SDK_VERSION_MAJOR, .minor = PROCESS_INFO_CURRENT_SDK_VERSION_MINOR
  },
};
