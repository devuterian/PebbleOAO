...
#define menu_layer_set_callbacks(ml, ctx, ...) \
  menu_layer_set_callbacks_by_value((ml), (ctx), __VA_ARGS__)
...
#define graphics_text_layout_get_content_size(...) \
  app_graphics_text_layout_get_content_size(__VA_ARGS__)
#define graphics_fill_rect(ctx, rect, rad, mask) \
  graphics_fill_round_rect_by_value((ctx), (rect), (rad), (mask))
#define graphics_draw_rect(ctx, rect) graphics_draw_rect_by_value((ctx), (rect))
#define graphics_draw_round_rect(ctx, rect, rad) \
  graphics_draw_round_rect_by_value((ctx), (rect), (rad))
#define graphics_draw_bitmap_in_rect(ctx, bmp, rect) \
  graphics_draw_bitmap_in_rect_by_value((ctx), (bmp), (rect))
